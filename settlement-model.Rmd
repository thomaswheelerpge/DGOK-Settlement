...
model_dependent_accounts <- c("WEL TOT CAP", "WELLS OBLIGATIONS NET SCHD", "forecast.wells.generation.min-mw", "PART_TOTAL_MAX_CAPACITY_MW-DGLS01", "PART_TOTAL_MIN_CAPACITY-DGLS01", "TOT DG LD MINUS URBN", "DG>OK LL", "DG>CHLN PAL LL", "DG>CHLN RR CEAEA", "BPA>DG PUMP", "DOPD NCW GEN", "AVA>DG LTI", "SENA>DG FRM")
...
NOTE: This code is essentially just doing a VLOOKUP and can be made more efficient by bulk transposing.
