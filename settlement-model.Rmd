...
Throughout this Rmd there is code that has # MANUALLY ASSIGNED written next to it. These are values that the user will input in manually through the dashboard
...
rrh_inflow <- 2500 #rt_data_filter("INFLOW_MWH-DGLS01") %>% select(Value) %>% sum()
